...
# Editable logic is split into ownership modules:
# - perception_pipeline.py: calls raw OpenCV detectors from image_detection.py
# - control_policy.py: steering/throttle decisions and manoeuvre latches
# - display_overlay.py: Perception and Lane Curve debug windows
    ...
    try:
        ...
        if latest_frame_data is not None:
            ...
            if frame is not None:
                ...
                # You may disable this if you don't need to display the frames / This could affect the fps
...
def processing_task():
    ...
    show_perception(front_per, rear_per, lane_offset, curve_dbg, hud)
...
if __name__ == '__main__':
    ...
    #   ReadBackCamera 50ms  LOW    - V2.0 rear chasing-car signal evolves slowly:
    #                                 longest deadline -> lowest priority. Also drains
    #                                 the back socket so the game's sender never blocks.

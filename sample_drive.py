...
#   * Challenge 2 CHASING CAR (rear teal, growing): forced lane change.
#   * Challenge 3 POLICE (front blue/red car): dodge if close, otherwise grab red.
# These outrank the normal front-orb logic.
# ---------------------------------------------------------------------------
